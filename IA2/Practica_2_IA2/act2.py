...
def plot():
      ...
      ax.plot(X,y,color="red",marker="o",markerfacecolor="blue",label="Actual Line")
      ax.plot(X,y_pred,color="blue",marker="o",markerfacecolor="blue",label="Predicted REgression")
...
tip.bind_widget(lstfare,balloonmsg="Actual Line")
tip.bind_widget(lstpredfare,balloonmsg="Predicted REgression")
